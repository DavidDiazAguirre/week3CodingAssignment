...
let myGreeting = new Greeting('David', 'New Mexico');
myGreeting.hello();
...
let yourBook = new Book('Norwegian Wood', 'Haruki Murakami');
...
console.log(fruit1.fruitDescription());
let fruit2 = new Fruit('banana', 'yellow', 'sweet');
console.log(fruit2.fruitDescription());
